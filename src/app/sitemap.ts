...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${base}/insights/what-is-geo`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${base}/insights/ai-automation-construction`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${base}/insights/spam-backlinks-what-they-mean`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${base}/insights/what-real-seo-looks-like`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
